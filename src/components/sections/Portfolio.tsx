      ...
      <div className="max-w-6xl mx-auto relative z-10">
        <ScrollReveal className="text-center mb-16">
          ...
          <h2
            ...
            className="mt-3 text-3xl md:text-5xl font-bold font-[family-name:var(--font-display)] mb-4"
          >
            Sites que <span className="hero-text-gradient">Criamos</span>
          </h2>
          <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
            Alguns dos projetos de criação de sites e landing pages que
            desenvolvemos para empresas de todo o Brasil.
          </p>
        </ScrollReveal>
